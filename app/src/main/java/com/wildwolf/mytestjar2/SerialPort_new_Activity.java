...
import com.wildwolf.mytestjar2.adapter.ListBaseAdapter;
import java.io.File;
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (add_dev1.getText().equals("设备添加网关") && cmd.equals("A802")) {
                                    ...
                                    show_active.setBackgroundColor(getResources().getColor(R.color.bg_green));
                                    ...
                                    show_active.setBackgroundColor(getResources().getColor(R.color.gray_bg));
...
//                            set_second_control_time_param();
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    show_active.setBackgroundColor(getResources().getColor(R.color.a1_orange_color));
                                }
                            });
                        }
                    } else {
